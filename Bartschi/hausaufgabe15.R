...
# Die Plots sehen gleich aus. An den R^2 Werten hat sich nichts geändert, genauso wie bei den 
# t-Werten. Allerdings hat sich das Intercept stark verändert.
...
# Der R^2 Wert hat sich nicht geändert, der t-Wert und die Koeffizienten im Intercept jedoch sehr,
# bei weight.kg und height.cm jedoch nicht.
# Beide Modelle scheinen gleich. Der Unterschied jedoch ist, dass das Intercept ein anderer ist.
...
# Die Regression mit dem Datensatz women, funktioniert deshalb besser, 
# weil es sich nur um Frauen im ungefähr gleichen Alter handelt und bei der Erhebung darauf geachtet wurde,
# dass die Umstände bei der Messung gleich sind.